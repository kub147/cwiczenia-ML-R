...
# Wnioski
Na podstawie przeprowadzonego dostrajania hiperparametrów dla modeli drzewa decyzyjnego oraz lasu losowego otrzymano następujące optymalne parametry:

##Model Drzewa Decyzyjnego
Cost Complexity: 1
Tree Depth: 1
Min N: 1
Zastosowanie tych wartości wskazuje na bardzo proste drzewo decyzyjne, co może sugerować ryzyko niedopasowania (underfitting) modelu do danych. Warto rozważyć eksperymentowanie z większą głębokością drzewa oraz innymi wartościami parametru cost complexity, aby uzyskać bardziej złożony model, który lepiej uchwyci zależności w danych.

##Model Lasu Losowego
Mtry: 1
Min N: 10
Optymalne wartości dla lasu losowego wskazują, że model wykorzystuje tylko jedną zmienną (nox lub no2) w każdym podziale drzewa, a jednocześnie wymaga przynajmniej 10 obserwacji do podziału. Taki dobór może pomóc w zminimalizowaniu przeuczenia i poprawić stabilność modelu.

##Podsumowanie
Dostrojone modele zostały skonfigurowane z wartościami, które potencjalnie mogą zapewnić dobre wyniki na zestawie testowym.